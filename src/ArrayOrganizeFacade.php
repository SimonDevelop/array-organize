...
class ArrayOrganizeFacade
{
     ...
     * @return array|bool Return data sorted | Return false if data array empty or not a array
     */
     ...
     * @return array|bool Return data column(s) filtered | Return false if not filtered
     */
     ...
     * @return array|bool Return data filtered | Return false if not filtered
     */
